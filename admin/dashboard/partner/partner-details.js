...
function renderPartner(partner) {
    console.log('Partner data:', partner); // Debug the input data
    ...
    console.log('Thumbnail URL:', thumbnailUrl); // Debug the thumbnail URL
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p><strong>Address:</strong> ${
                            partner.address
                                ? `${partner.address.addressLine1 || 'N/A'}, ${partner.address.country || 'N/A'}`
                                : 'No address provided'
                        }</p>
                    </div>
                </div>
